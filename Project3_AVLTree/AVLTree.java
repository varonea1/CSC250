...
*
*This is the class that manipulates the tree.  It has methods for inserting and deleting nodes as well as
to count the height and amount of nodes in the tree.
********************************************************/
...
public class AVLTree {
    ...
    /*  if(this.find(ss)) {
      ...
      //checks if the node is the root and deletes it if it is
    ...
    private AVLNode maxOfSubtree(AVLNode node ){
        ...
        //ensures it is the left subtree
        node = node.getLeft();
